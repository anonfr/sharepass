    ...
    <div className="min-h-screen flex flex-col">
            ...
            <>
              ...
              <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                <FeatureCard 
                  ...
                  description="Jump right in without creating an account or providing personal information."
                />
                <FeatureCard 
                  title="Password Protected"
                  description="Your content is secured with a password that only you and your recipients know."
                />
                <FeatureCard 
                  title="Text & Images"
                  description="Share formatted text and images all in one secure, easy-to-access location."
                />
              </div>
            </>
          ) : (
      ...
      <footer className="w-full py-6 border-t">
        <div className="max-w-6xl mx-auto px-4 text-center text-sm text-muted-foreground">
          <p>EasyAccess — Simple, secure sharing without the hassle.</p>
        </div>
      </footer>
    </div>
  );
